...
import {Channel, ChannnelType, MemberRole, Server} from "@prisma/client";
...
const iconMap = {
    [ChannnelType.TEXT]: Hash,
    [ChannnelType.AUDIO]: Mic,
    [ChannnelType.VIDEO]: Video,
}
...
const ServerChannel = ( { channel, server, role }: ServerChannelProps ) => {
    ...
    const onAction = (e: React.MouseEvent, action: ModalType) => {
        e.stopPropagation();  // prevents the events bubbling up the DOM tree
