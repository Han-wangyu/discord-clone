...
const iconMap = {
    [ChannnelType.TEXT]: <Hash className={"mr-2 w-4 h-4"}/>,
    [ChannnelType.AUDIO]: <Mic className={"mr-2 w-4 h-4"}/>,
    [ChannnelType.VIDEO]: <Video className={"mr-2 w-4 h-4"}/>
}
    ...
    return (
        <div className={"flex flex-col h-full text-primary w-full dark:bg-[#2B2D31] bg-[#F2F3F5]"}>
            ...
            <ScrollArea className={"flex-1 px-3"}>
                ...
                { !!textChannels?.length && (
                    <div className={"mb-2"}>
                        <ServerSection sectionType={"channels"} channelType={ChannnelType.TEXT} role={role} label={"Text Channels"} />
                ...
                { !!audioChannels?.length && (
                    <div className={"mb-2"}>
                        <ServerSection sectionType={"channels"} channelType={ChannnelType.AUDIO} role={role} label={"Voice Channels"} />
                        <div className="space-y-[2px]">
                ...
                { !!videoChannels?.length && (
                    <div className={"mb-2"}>
                        <ServerSection sectionType={"channels"} channelType={ChannnelType.VIDEO} role={role} label={"Video Channels"} />
                        <div className="space-y-[2px]">
